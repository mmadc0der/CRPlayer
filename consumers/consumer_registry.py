...
class ConsumerFactory(ABC):
  ...
  @abstractmethod
  def create_consumer(self, consumer_id: str, stream_buffer: SharedStreamBuffer, **kwargs) -> StreamConsumer:
...
class ConsumerRegistry:
  ...
  def create_consumer(self, consumer_type: str, consumer_id: str, **kwargs) -> Optional[StreamConsumer]:
...
class ConsumerBuilder:
  ...
  def build(self) -> Optional[StreamConsumer]:
    ...
    return self.registry.create_consumer(self.consumer_type, self.consumer_id, **self.kwargs)
