...
class DatasetInspector:
  ...
  def analyze_class_balance(self, dataset_id: int) -> Dict[str, Any]:
    ...
    try:
      ...
      analysis = {
        ...
        least_common,
        'imbalance_ratio':
        most_common[1] / least_common[1] if most_common and least_common and least_common[1] > 0 else float('inf')
      }
  ...
  def download_dataset(self, dataset_id: int, output_dir: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
      ...
      return {'output_dir': str(output_path), 'metadata': metadata, 'dataframe': df}
...
def create_data_loaders(data: List[Dict[str, Any]],
                        data_root: str,
