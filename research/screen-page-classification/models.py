...
class ModelFactory:
    ...
    def create_model(
        ...
        **kwargs
        ...
        model_configs = {
            'resnet50': {'class': ResNetClassifier, 'model_name': 'resnet50'},
            'resnet101': {'class': ResNetClassifier, 'model_name': 'resnet101'},
            'efficientnet_b0': {'class': EfficientNetClassifier, 'model_name': 'efficientnet_b0'},
            'efficientnet_b3': {'class': EfficientNetClassifier, 'model_name': 'efficientnet_b3'},
            'vit_base': {'class': VisionTransformerClassifier, 'model_name': 'vit_base_patch16_224'},
            'vit_large': {'class': VisionTransformerClassifier, 'model_name': 'vit_large_patch16_224'},
            'convnext_tiny': {'class': ConvNeXtClassifier, 'model_name': 'convnext_tiny'},
            'convnext_small': {'class': ConvNeXtClassifier, 'model_name': 'convnext_small'},
            'lightweight': {'class': LightweightClassifier}
        }
