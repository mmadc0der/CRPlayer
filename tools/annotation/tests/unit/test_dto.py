...
class TestErrorResponse:
  ...
  def test_error_response_with_details(self):
    ...
    error = ErrorResponse(code="validation_error", message="Validation failed", details=details)
  ...
  def test_error_response_dict_serialization(self):
    ...
    error = ErrorResponse(code="test_error", message="Test message", details={"key": "value"})

    result = error.model_dump()
    expected = {"code": "test_error", "message": "Test message", "details": {"key": "value"}}
...
class TestSaveRegressionRequest:
  ...
  def test_save_regression_with_frame_id(self):
    ...
    request = SaveRegressionRequest(session_id="test_session", dataset_id=1, frame_id="frame_001", value=42.5)
  ...
  def test_save_regression_with_frame_idx(self):
    ...
    request = SaveRegressionRequest(session_id="test_session", dataset_id=1, frame_idx=10, value=99.9)
  ...
  def test_save_regression_missing_frame_identifier(self):
    ...
    with pytest.raises(ValidationError, match="Either frame_id or frame_idx must be provided"):
      SaveRegressionRequest(session_id="test_session", dataset_id=1, value=42.5)
  ...
  def test_save_regression_both_frame_identifiers(self):
    ...
    request = SaveRegressionRequest(session_id="test_session",
                                    dataset_id=1,
                                    frame_id="frame_001",
                                    frame_idx=10,
                                    value=42.5)
...
class TestSaveSingleLabelRequest:
  ...
  def test_save_single_label_with_class_id(self):
    ...
    request = SaveSingleLabelRequest(session_id="test_session", dataset_id=1, frame_id="frame_001", class_id=5)
  ...
  def test_save_single_label_with_category_name(self):
    ...
    request = SaveSingleLabelRequest(session_id="test_session",
                                     dataset_id=1,
                                     frame_id="frame_001",
  ...
  def test_save_single_label_missing_class_identifier(self):
    ...
    with pytest.raises(ValidationError, match="Either class_id or category_name must be provided"):
      SaveSingleLabelRequest(session_id="test_session", dataset_id=1, frame_id="frame_001")

  def test_save_single_label_empty_category_name(self):
    """Test SaveSingleLabelRequest with empty category_name fails."""
    with pytest.raises(ValidationError, match="Either class_id or category_name must be provided"):
      SaveSingleLabelRequest(session_id="test_session", dataset_id=1, frame_id="frame_001", category_name="")
...
class TestSaveMultilabelRequest:
  ...
  def test_save_multilabel_with_class_ids(self):
    ...
    class_ids = [1, 2, 3]
    request = SaveMultilabelRequest(session_id="test_session", dataset_id=1, frame_id="frame_001", class_ids=class_ids)
  ...
  def test_save_multilabel_empty_class_ids(self):
    ...
    request = SaveMultilabelRequest(session_id="test_session", dataset_id=1, frame_id="frame_001", class_ids=[])
  ...
  def test_save_multilabel_missing_frame_identifier(self):
    ...
    with pytest.raises(ValidationError, match="Either frame_id or frame_idx must be provided"):
      SaveMultilabelRequest(session_id="test_session", dataset_id=1, class_ids=[1, 2, 3])
...
class TestUpsertDatasetSessionSettingsRequest:
  ...
  def test_upsert_settings_valid(self):
    ...
    request = UpsertDatasetSessionSettingsRequest(dataset_id=1, session_id="test_session", settings=settings)
  ...
  def test_upsert_settings_session_id_trimming(self):
    ...
    request = UpsertDatasetSessionSettingsRequest(dataset_id=1, session_id="  test_session  ", settings={})
  ...
  def test_upsert_settings_missing_fields(self):
    ...
    with pytest.raises(ValidationError):
      UpsertDatasetSessionSettingsRequest(dataset_id=1, session_id="test_session"
                                          # Missing settings
                                          )

    with pytest.raises(ValidationError):
      UpsertDatasetSessionSettingsRequest(dataset_id=1, settings={}
                                          # Missing session_id
                                          )
...
class TestDTOEdgeCases:
  ...
  def test_pydantic_version_compatibility(self):
    ...
    request = SaveRegressionRequest(session_id="test", dataset_id=1, frame_id="frame_001", value=42.0)
  ...
  def test_none_values_handling(self):
    ...
    request = SaveRegressionRequest(session_id="test",
                                    dataset_id=1,
                                    frame_id="frame_001",
                                    value=42.0,
  ...
  def test_type_coercion(self):
    ...
    request = SaveRegressionRequest(
      ...
      dataset_id="1",
      frame_id="frame_001",
      value=42.0  # String instead of int
    )
