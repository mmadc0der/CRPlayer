    ...
    with patch.object(annotation_service, "_conn") as mock_conn:
      ...
      with patch("services.annotation_service.get_session_db_id", return_value=123):
        with patch("services.annotation_service.get_frame_db_id", return_value=456):
          session_db_id, frame_db_id = annotation_service._resolve_ids(mock_connection, "test_session", "frame_001")
      ...
      with patch.object(annotation_service, "_resolve_ids", return_value=(123, 456)):
        with patch("services.annotation_service.upsert_regression") as mock_upsert:
          with patch.object(
            ...
            result = annotation_service.save_regression(session_id="test_session",
                                                        dataset_id=1,
                                                        frame_id="frame_001",
                                                        value=42.5)
      ...
      with patch.object(annotation_service, "_resolve_ids", return_value=(123, 456)):
        with patch("services.annotation_service.upsert_single_label") as mock_upsert:
          with patch.object(
            ...
            result = annotation_service.save_single_label(session_id="test_session",
                                                          dataset_id=1,
                                                          frame_id="frame_001",
                                                          class_id=2)
      ...
      with patch.object(annotation_service, "_resolve_ids", return_value=(123, 456)):
        with patch("services.annotation_service.replace_multilabel_set") as mock_replace:
          with patch.object(
            ...
            result = annotation_service.save_multilabel(session_id="test_session",
                                                        dataset_id=1,
                                                        frame_id="frame_001",
                                                        class_ids=class_ids)
    ...
    with patch.object(annotation_service, "_conn") as mock_conn:
      ...
      with patch("services.annotation_service.get_session_db_id", return_value=123):
        with patch("services.annotation_service.list_frames_with_annotations") as mock_list:
          ...
          result = annotation_service.list_annotations_for_session(session_id="test_session", dataset_id=1)
    ...
    with patch.object(annotation_service, "_conn") as mock_conn:
      ...
      with patch("services.annotation_service.get_session_db_id", return_value=123):
        with patch("services.annotation_service.list_frames_with_annotations") as mock_list:
          ...
          annotation_service.list_annotations_for_session(session_id="test_session", dataset_id=1, labeled_only=True)
    ...
    with patch.object(annotation_service, "_conn") as mock_conn:
      ...
      with patch.object(annotation_service, "_resolve_ids", side_effect=Exception("Database error")):
        with pytest.raises(Exception, match="Database error"):
          annotation_service.save_regression(session_id="test_session", dataset_id=1, frame_id="frame_001", value=42.5)
