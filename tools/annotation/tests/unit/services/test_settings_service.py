...
class TestSettingsService(TestSettingsServiceBase):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.repo_upsert_dataset_session_settings") as mock_upsert:
        with patch("services.settings_service.get_session_db_id", return_value=123) as mock_get_id:
          settings_service.upsert_dataset_session_settings(dataset_id=1,
  ...
  def test_upsert_dataset_session_settings_error_handling(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.get_session_db_id", return_value=1), patch(
          "services.settings_service.repo_upsert_dataset_session_settings",
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.repo_get_dataset_session_settings") as mock_get:
        with patch("services.settings_service.get_session_db_id", return_value=123) as mock_get_id:
          ...
          result = settings_service.get_dataset_session_settings(dataset_id=1, session_id_str="test_session")
  ...
  def test_get_dataset_session_settings_not_found(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.get_session_db_id",
                 return_value=None), patch("services.settings_service.repo_get_dataset_session_settings") as mock_get:
        mock_get.return_value = {}

        result = settings_service.get_dataset_session_settings(dataset_id=1, session_id_str="nonexistent_session")
  ...
  def test_clear_dataset_session_settings_success(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.get_session_db_id",
                 return_value=1), patch("services.settings_service.repo_delete_dataset_session_settings") as mock_clear:
        mock_clear.return_value = 1  # One row affected

        result = settings_service.clear_dataset_session_settings(dataset_id=1, session_id_str="test_session")
  ...
  def test_clear_dataset_session_settings_not_found(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch(
          "services.settings_service.get_session_db_id",
          return_value=None), patch("services.settings_service.repo_delete_dataset_session_settings") as mock_clear:
        mock_clear.return_value = 0  # No rows affected

        result = settings_service.clear_dataset_session_settings(dataset_id=1, session_id_str="nonexistent_session")
  ...
  def test_connection_management(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.get_session_db_id",
                 return_value=1), patch("services.settings_service.repo_get_dataset_session_settings"):
  ...
  def test_transaction_handling_in_upsert(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch("services.settings_service.get_session_db_id",
                 return_value=1), patch("services.settings_service.repo_upsert_dataset_session_settings"):
        settings_service.upsert_dataset_session_settings(dataset_id=1,
                                                         session_id_str="test_session",
                                                         settings={"key": "value"})
  ...
  def test_settings_validation(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch(
          "services.settings_service.get_session_db_id",
          return_value=1), patch("services.settings_service.repo_upsert_dataset_session_settings") as mock_upsert:
        settings_service.upsert_dataset_session_settings(dataset_id=1, session_id_str="test_session", settings=None)
  ...
  def test_empty_settings_handling(self, settings_service):
    ...
    with patch.object(settings_service, "_conn") as mock_conn:
      ...
      with patch(
          "services.settings_service.get_session_db_id",
          return_value=1), patch("services.settings_service.repo_upsert_dataset_session_settings") as mock_upsert:
        settings_service.upsert_dataset_session_settings(dataset_id=1, session_id_str="test_session", settings={})
