...
class TestProjectsAPI:
  ...
  def test_create_project_invalid_data(self, client: FlaskClient):
    ...
    response = client.post(
      "/api/projects",
      data=json.dumps({}),
      content_type="application/json"  # Missing required fields
    )
  ...
  def test_create_project_duplicate_name(self, client: FlaskClient):
    ...
    response1 = client.post("/api/projects", data=json.dumps(project_data), content_type="application/json")
    assert response1.status_code in [200, 201]  # 200 if exists, 201 if created

    # Try to create second project with same name
    response2 = client.post("/api/projects", data=json.dumps(project_data), content_type="application/json")
  ...
  def test_update_project_success(self, client: FlaskClient):
    ...
    response = client.put(f"/api/projects/{project_id}", data=json.dumps(update_data), content_type="application/json")
  ...
  def test_update_nonexistent_project(self, client: FlaskClient):
    ...
    response = client.put("/api/projects/999", data=json.dumps(update_data), content_type="application/json")
  ...
  def test_delete_project_with_datasets_fails(self, client: FlaskClient):
    ...
    client.post(f"/api/projects/{project_id}/datasets", data=json.dumps(dataset_data), content_type="application/json")
...
class TestDatasetsAPI:
  ...
  def test_create_dataset_success(self, client: FlaskClient):
    ...
    # Create dataset
    dataset_data = DatasetDataFactory()
    response = client.post(f"/api/projects/{project_id}/datasets",
  ...
  def test_create_dataset_invalid_project(self, client: FlaskClient):
    ...
    dataset_data = DatasetDataFactory()
    response = client.post("/api/projects/999/datasets", data=json.dumps(dataset_data), content_type="application/json")
  ...
  def test_list_datasets_with_data(self, client: FlaskClient):
    ...
    client.post(f"/api/projects/{project_id}/datasets", data=json.dumps(dataset1_data), content_type="application/json")
  ...
  def test_update_dataset_success(self, client: FlaskClient):
    ...
    response = client.put(f"/api/datasets/{dataset_id}", data=json.dumps(update_data), content_type="application/json")
