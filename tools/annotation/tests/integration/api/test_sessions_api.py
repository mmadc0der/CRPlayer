...
class TestSessionsAPI:
    ...
    def test_session_ordering(self, client: FlaskClient):
        ...
        mock_sessions = [
            {"session_id": "session_c", "path": "/c", "frames_count": 1},
            {"session_id": "session_a", "path": "/a", "frames_count": 1},
            {"session_id": "session_b", "path": "/b", "frames_count": 1}
        ]
    ...
    def test_session_frame_counts(self, client: FlaskClient):
        ...
        mock_sessions = [
            {"session_id": "empty_session", "path": "/empty", "frames_count": 0},
            {"session_id": "small_session", "path": "/small", "frames_count": 5},
            {"session_id": "large_session", "path": "/large", "frames_count": 1000}
        ]
