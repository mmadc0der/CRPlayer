...
class GameDataCollector:
  ...
  def setup_directories(self):
    ...
    directories = [
      self.output_dir, self.output_dir / "frames", self.output_dir / "sessions", self.output_dir / "annotations"
    ]
  ...
  def start_session(self, session_name: Optional[str] = None, game_name: str = "unknown_game", notes: str = "") -> str:
    """
